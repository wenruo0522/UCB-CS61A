# Homework 3: Recursion, Tree Recursion<kbd>[hw03.zip](./hw03.zip)</kbd>

*Due by 11:59pm on Thursday, February 15*

## Instructions

Download [hw03.zip](./hw03.zip). Inside the archive, you will find a file called [hw03.py](https://cs61a.org/hw/hw03/hw03.py), along with a copy of the `ok` autograder.
...
**Using Ok:** If you have any questions about using Ok, please refer to [this guide.](../articles/using-ok.md)
...
1. Fall 2017 MT1 Q4a: [Digital](./61a-fa17-mt1.pdf)
2. Summer 2018 MT1 Q5a: [Won't You Be My Neighbor?](./61a-su18-mt.pdf)
3. Fall 2019 Final Q6b: [Palindromes](./61a-fa19-final.pdf)
